    ...
    private 
    	...
    	def anscomment_create
    		...
    		@chosens.each do |chose|
    			...
    			@noti = Notification.create(user_id: chose.user_id,resource_type:"question", text: "New comment to answer "+self.text[0..20]+" to question "+self.answer.question.name, resource_id:self.answer.question.id)
    			@noti.save
    			#end
    		end
    	end
